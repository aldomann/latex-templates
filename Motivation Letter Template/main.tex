...
\documentclass[11pt,a4paper,lmodern]{moderncv}        % possible options include font size ('10pt', '11pt' and '12pt'), paper size ('a4paper', 'letterpaper', 'a5paper', 'legalpaper', 'executivepaper' and 'landscape') and font family ('sans' and 'roman')
...
% personal data
\name{Alfredo}{Hernández Cavieres}
...
%-----       letter       ---------------------------------------------------------
% recipient data
\recipient{Someplace}{221 Streetname \\ 12345 City (State)}
\date{\today}
